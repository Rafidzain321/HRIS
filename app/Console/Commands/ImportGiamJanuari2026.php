...
class ImportGiamJanuari2026 extends Command
{
    protected $signature   = 'import:giam-januari2026';
    protected $description = 'Import Giam staff/mechanical/default (default) beserta timesheet dan data gaji Januari 2026';
    ...
    public function handle(): int
    {
        $tahun      = 2026;
        $bulan      = 1;
        $dibuatOleh = 'Import GIAM Staff/Mechanical/Default Januari 2026';
        ...
        $sources = [
            'staff'      => storage_path('app/data-entry/giam-staff-januari2026.json'),
            'mechanical' => storage_path('app/data-entry/giam-mechanical-januari2026.json'),
            'default'    => storage_path('app/data-entry/giam-default-januari2026.json'),
        ];
